...
impl Rgb {
    ...
    pub fn scale(self, s: f32) -> Self {
        ...
        Rgb::new(
            clamp(self.r as f32 * s),
            clamp(self.g as f32 * s),
            clamp(self.b as f32 * s),
        )
    }
...
#[derive(Debug, Clone)] // <- añade Debug
pub enum Albedo {
    Solid(Rgb),
    Tex(Arc<crate::texture::Texture>),
}
...
impl Material {
    pub fn solid(c: Rgb) -> Self {
        Self {
            albedo: Albedo::Solid(c),
        }
    }
    pub fn textured(tex: Arc<crate::texture::Texture>) -> Self {
        Self {
            albedo: Albedo::Tex(tex),
        }
    }
}
